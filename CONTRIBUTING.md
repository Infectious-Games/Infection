...
```
git remote add upstream https://github.com/Infectious-Games/Infection.git
```
...
This will start the process. You must commit all of your changes
before doing this. If there are no conflicts, this should just roll all
of your changes back on top of the changes from upstream, leading to a
nice, clean, linear commit history.

If there are conflicting changes, sort out the conflicts. Checki all of 
the files git says have been changed in both histories
...
- [ ] Did I pull from the upstream master branch after I finished all my
  work?
